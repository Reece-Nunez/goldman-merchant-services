          ...
          <FadeInUp>
            <div className="prose prose-slate prose-lg max-w-none">
              ...
              <p className="text-slate-600 mb-4">
                ...
                <a href="mailto:info@goldmanmerchantservices.com" className="text-amber-600 hover:text-amber-700">
                  info@goldmanmerchantservices.com
                </a>.
              </p>
            </div>
          </FadeInUp>
